...
| [authoritative-primary-outage-replay](./authoritative-primary-outage-replay) | Can an Artifacts-backed authoritative primary durably accept and serve Git pushes while the origin is unavailable, then replay them to convergence? | 🧪 In progress — real binding create, smart-HTTP push/clone, OID equality, and strict fsck passed; outage replay remains |
