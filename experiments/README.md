...
| [dual-gitea-replication-semantics](./dual-gitea-replication-semantics) | Can one workerd proxy stream every push to two Giteas, round-robin reads, and report partial writes honestly? | 🧪 In progress — exercise convergence, asymmetric failures, backpressure, and recovery |
