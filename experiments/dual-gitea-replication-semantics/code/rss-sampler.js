...
const [pidText, label, sizeText, outputPath, readyPath] = process.argv.slice(2);
if (!pidText || !label || !sizeText || !outputPath || !readyPath) {
  console.error('usage: node rss-sampler.js PID LABEL SIZE_MIB OUTPUT_JSONL READY_FILE');
  process.exit(2);
}
